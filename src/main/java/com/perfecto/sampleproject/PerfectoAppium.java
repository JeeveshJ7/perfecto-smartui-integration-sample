...
public class PerfectoAppium {
	...
	public void appiumTest() throws Exception {
		...
		SmartUIAppSnapshot SmartUI = new SmartUIAppSnapshot(); // Assuming this is the correct initialization
		...
		SmartUI.smartuiAppSnapshot(driver,"NAME",ssConfig);
		...
		reportiumClient.stepEnd();
		// smartUi.smartUiAppSnapshot(driver,"teep",ssConfig);
